...
switch ($soal_id) {
    ...
    default:
        ...
        $queryNomorSoal    =  $soal->SelectDataSoalModul($soal_id, 'modul_2');
        break;
}
            ...
            <section class="content row">
                <div class="col-12 " id="pane_soal">
                    <div class="card pb-5 pt-5" id="card-main">
                        ...
                        <form action="../query/peserta_query" method="post" class="mt-2" id="soal_asli" hidden>
                            <table>
                                ...
                                <?php if ($resultSoalModul->num_rows > 0) : ?>
                                    ...
                                    <div class="row">
                                        <div class="col  pl-5 pr-5">
                                            <div class="form-group">
                                                <label class="teks-soal"><?= $arraySoal[$index - 1]['nomor_soal'] ?> . <span class="font-weight-normal ml-3"> <?= $arraySoal[$index - 1]['teks_soal'] ?></span> </label>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="row h4 mt-3 mb-4 pl-5 pr-5 font-weight-bold" style="font-size: 23px;">
                                        <div class="col">
                                            <input class="" type="radio" name="jawaban" id="exampleRadios2" <?php if (isset($draft_jawaban) && $draft_jawaban == 'bunga') { ?> checked="checked" <?php } ?> value="bunga">
                                            <label class="" for="exampleRadios2">
                                                Bunga
                                            </label>
                                        </div>
                                        <div class="col">
                                            <input class="" type="radio" name="jawaban" id="exampleRadios2" <?php if (isset($draft_jawaban) && $draft_jawaban == 'perkakas') { ?> checked="checked" <?php } ?> value="perkakas">
                                            <label class="" for="exampleRadios2">
                                                Perkakas
                                            </label>
                                        </div>
                                        <div class="col">
                                            <input class="" type="radio" name="jawaban" id="exampleRadios2" <?php if (isset($draft_jawaban) && $draft_jawaban == 'burung') { ?> checked="checked" <?php } ?> value="burung">
                                            <label class="" for="exampleRadios2">
                                                Burung
                                            </label>
                                        </div>
                                        <div class="col">
                                            <input class="" type="radio" name="jawaban" id="exampleRadios2" <?php if (isset($draft_jawaban) && $draft_jawaban == 'kesenian') { ?> checked="checked" <?php } ?> value="kesenian">
                                            <label class="" for="exampleRadios2">
                                                Kesenian
                                            </label>
                                        </div>
                                        <div class="col">
                                            <input class="" type="radio" name="jawaban" id="exampleRadios2" <?php if (isset($draft_jawaban) && $draft_jawaban == 'binatang') { ?> checked="checked" <?php } ?> value="binatang">
                                            <label class="" for="exampleRadios2">
                                                Binatang
                                            </label>
                                        </div>
