...
switch ($soal_id) {
    ...
    default:
        ...
        $queryNomorSoal    =  $soal->SelectDataSoalModul($soal_id, 'modul_10_ge');
        break;
}
            ...
            <section class="content row">
                <div class="col-12" id="pane_soal">
                    <div class="card pb-5 pt-5" id="card-main">
                        ...
                        <form hidden id="soal_asli" action="../query/peserta_query" method="post" class="mt-2">
                            <?php if ($resultSoalModul->num_rows > 0) : ?>
                                ...
                                <div class="row" style="margin:auto;">
                                    ...
                                    <div class="col-md-11">
                                        <div class="form-group">
                                            <label class="teks-soal"><?= $arraySoal[$index - 1]['nomor_soal'] ?>.<?= $arraySoal[$index - 1]['teks_soal'] ?></label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
