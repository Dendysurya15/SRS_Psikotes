...
if (isset($_SESSION['kerja_soal'])) {
    if ($_SESSION['kerja_soal'] != 'soal_10_ge') {
        $soal->KerjaSoal($_SESSION['kerja_soal']);
    }
}

$timer = '';
$resultSelSoal      = $soal->SelectSoal2('Modul 10 GE');
...
switch ($soal_id) {
    ...
    default:
        $resultSoalModul    =  $soal->SelectDataSoalModul($soal_id, 'modul_10_ge');
        break;
}
...
$arr_s2     = explode('=', $arr_s1[14]);

$status_s   = $arr_s2[1];

$resSoal2         = $soal->SelectSoal2('Modul 10 GE');
...
if ($status_s == 1) {
    if ($_SESSION['w_selesai'] == '') {
        ...
        $resSoal1         = $soal->SelectSoal2('Modul 10 GE');
                    ...
                    <div class="card">
                        ...
                        <form id="soal_contoh" class="mt-5">
                            ...
                            <div class="row" style="margin:auto;">
                                ...
                                <div class="col-md-11">
                                    <div class="form-group">
                                        <label class="teks-soal">1. Mawar - Melati</label>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <input type="text" style="height: 50px; font-weight: normal;" placeholder="Jawab..." class="teks-soal jawaban form-control" name="jawaban_1">
                                    </div>
                                </div>
                            </div>
                            <!-- NOMOR 1 -->
                            ...
                            <div class="row mt-5" style="margin:auto;">
                                ...
                                <div class="col-md-11">
                                    <div class="form-group">
                                        <label class="teks-soal">2. Mata - telinga</label>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <input type="text" style="height: 50px; font-weight: normal;" placeholder="Jawab..." class="teks-soal jawaban form-control" name="jawaban_2">
                                    </div>
                                </div>
                            </div>
                            <!-- NOMOR 2 -->
                            ...
                            <div class="row mt-5" style="margin:auto;">
                                ...
                                <div class="col-md-11">
                                    <div class="form-group">
                                        <label class="teks-soal">3. Gula - intan</label>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <input type="text" style="height: 50px; font-weight: normal;" placeholder="Jawab..." class="teks-soal jawaban form-control" name="jawaban_3">
                                    </div>
                                </div>
                            </div>
                            <!-- NOMOR 3 -->
                        ...
                        <form hidden id="soal_asli" action="../query/peserta_query" method="post" class="mt-5">
                            <?php if ($resultSoalModul->num_rows > 0) : ?>
                                ...
                                <?php while ($rowSoalModul = $resultSoalModul->fetch_assoc()) : ?>
                                    ...
                                    <?php if ($index == 0) : ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <input type="text" style="height: 50px; font-weight: normal;" placeholder="Jawab..." class="teks-soal jawaban form-control" disabled name="jawaban_<?= $rowSoalModul['nomor_soal'] ?>">
                                                </div>
                                            </div>
                                        </div>
                                    <?php else : ?>
                                ...
                                <div class="row mt-5 mb-4" style="margin:auto; text-align:center;">
                                    <div class="col-md-12">
                                        <input hidden class="btn btn-secondary w-50" type="submit" value="Submit Jawaban" name="soal_10_ge" id="soal_10_ge">
                                        <input class="btn btn-success w-50 button-tes" type="button" value="KIRIM JAWABAN" name="soal_10_ge_" id="soal_10_ge_">
                                    </div>
                                </div>
                            <?php endif; ?>
                        </form>
