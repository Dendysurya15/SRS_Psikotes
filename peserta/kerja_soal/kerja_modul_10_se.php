...
switch ($soal_id) {
    ...
    default:
        ...
        $queryNomorSoal    =  $soal->SelectDataSoalModul($soal_id, 'modul_10_se');
        break;
}
            ...
            <section class="content row">
                <div class="col-12" id="pane_soal">
                    <div class="card pb-5 pt-5" id="card-main">
                        ...
                        <form id="soal_asli" hidden action="../query/peserta_query" method="post">
                            <?php if ($resultSoalModul->num_rows > 0) : ?>
                                <div class="col pl-4 pr-4">
                                    <label class="teks-soal"><?= $arraySoal[$index - 1]['nomor_soal'] ?>.<?= $arraySoal[$index - 1]['teks_soal'] ?></p>
                                ...
                                <div class="row mt-2">
                                    <?php
                                    $pilihan = explode(';', $arraySoal[$index - 1]['pilihan']);
                                    ?>
                                    <?php for ($i = 0; $i < count($pilihan) - 1; $i++) : ?>
                                        <div class="row w-50">
                                            <div class="col pl-4 pr-4 mr-4 ml-4">
                                                <input class="jawaban" disabled name="jawaban" id="optionsRadios1" <?php if (isset($draft_jawaban) && $draft_jawaban == $arr_abjad[$i]) { ?> checked="checked" <?php } ?> value="<?= $arr_abjad[$i] ?>" type="radio">
                                                <label class="" style="font-weight: normal; font-size: 15pt;"><?= strtoupper($arr_abjad[$i]) ?>.<?= strtoupper($pilihan[$i]) ?></label>
                                            </div>
                                        </div>
                                    <?php endfor; ?>
                                </div>
                                ...
                                <div class="col-12 pt-4">
                                    ...
                                    <button hidden name="soal_10_se" id="soal_10_se" class="btn btn-secondary w-50" type="submit">
                                        Submit
                                    </button>
                                    <button name="soal_10_se_" hidden id="soal_10_se_" class="float-right btn btn-success  mr-5" type="button">
                                        KIRIM JAWABAN
                                    </button>
                                </div>
                            <?php endif; ?>
