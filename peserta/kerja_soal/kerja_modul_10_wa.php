...
switch ($soal_id) {
    ...
    default:
        ...
        $queryNomorSoal    =  $soal->SelectDataSoalModul($soal_id, 'modul_10_wa');
        break;
}
                        ...
                        <form hidden id="soal_asli" action="../query/peserta_query" method="post" class="mt-2">
                            <?php if ($resultSoalModul->num_rows > 0) : ?>
                                ...
                                <div class="col pl-4 pr-4">
                                    <label class="teks-soal"><?= $arraySoal[$index - 21]['nomor_soal'] ?>.</label>
                                </div>

                                <div class="row mt-2">
                                    <?php
                                    $pilihan = explode(';', $arraySoal[$index - 21]['pilihan']);
                                    ?>
                                ...
                                <div class="col-12 pt-4 ">
                                    ...
                                    <button hidden name="soal_10_wa" id="soal_10_wa" class="btn btn-secondary w-50" type="submit">
                                        Submit
                                    </button>
                                    <button name="soal_10_wa_" hidden id="soal_10_wa_" class="float-right btn btn-success  mr-5" type="button">
                                        KIRIM JAWABAN
                                    </button>
                                </div>
                            <?php endif; ?>
