            ...
            <section class="content row">
                <div class="col-9">
                    <div class="card">
                        ...
                        <form action="../query/peserta_query" method="post" class="mt-4 ml-5" hidden id="soal_asli">
                            <?php if ($resultSoalModul->num_rows > 0) : ?>
                                ...
                                <?php while ($rowSoalModul = $resultSoalModul->fetch_assoc()) : ?>
                                    ...
                                    <?php if ($index <= 1) : ?>
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <input class="form-control jawaban mt-2" disabled type="number" step="0.01" name="jawaban_<?= $rowSoalModul['nomor_soal'] ?>" placeholder="Jawab...">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row mt-2 mb-4" style="margin:auto; text-align: center;">
                                    <div class="col-md-11">
                                        <input hidden name="soal_4" id="soal_4" class="btn btn-secondary w-100" type="submit" value="Submit Jawaban">
                                        <input name="soal_4_" id="soal_4_" class="btn btn-success w-50 button-tes" type="button" value="KIRIM JAWABAN">
                                    </div>
                                </div>
                            <?php endif; ?>
                        </form>
