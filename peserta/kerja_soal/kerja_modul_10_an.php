...
switch ($soal_id) {
    ...
    default:
        ...
        $queryNomorSoal    =  $soal->SelectDataSoalModul($soal_id, 'modul_10_an');
        break;
}
                        ...
                        <form hidden id="soal_asli" action="../query/peserta_query" method="post" class="mt-2">
                            <?php if ($resultSoalModul->num_rows > 0) : ?>
                                ...
                                <div class="row" style="margin:auto;">
                                    ...
                                    <div class="col-md-11">
                                        <div class="form-group">
                                            <label class="teks-soal"><?= $arraySoal[$index - 41]['nomor_soal'] ?>.<?= $arraySoal[$index - 41]['teks_soal'] ?> </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <?php
                                    $pilihan = explode(';', $arraySoal[$index - 41]['pilihan']);
                                    ?>
                                ...
                                <div class="col-12 pt-4 ">
                                    ...
                                    <button hidden name="soal_10_an" id="soal_10_an" class="btn btn-secondary w-50" type="submit">
                                        Submit
                                    </button>
                                    <button name="soal_10_an_" id="soal_10_an_" hidden class="float-right btn btn-success  mr-5" type="button">
                                        KIRIM JAWABAN
                                    </button>
                                </div>
                            <?php endif; ?>
