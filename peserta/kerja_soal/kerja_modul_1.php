        ...
        <div class="content-wrapper">
            ...
            <section class="content row">
                ...
                <div class="col-3">
                    <div class="card">
                        <div class="card-body">
                            <div class="row text-center justify-content-center" style="height:100%">
                                <p class="" style="border: 1px solid #DFDFDF;margin-left:5px;margin-top:-10px;line-height: 30px;border-radius: 3px;width: 35px;height: 30px;font-size: 10pt;"> 12</p>
                            </div>
                        </div>
                    </div>
                </div>
