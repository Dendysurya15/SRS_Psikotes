...
if (isset($_POST['add_soal'])) {
    $pindah_html    = '../soal/modul_10_ra';



    $cekNomorSoal   = $soal->CekNomorSoal($_POST['add_nomor'], 'modul_10_ra');
    switch ($cekNomorSoal) {
        case 'TIDAK ADA':
            $nama_modul = 'modul_10_ra';
            $pilihan    = '';
...
if (isset($_POST['update_soal'])) {
    ...
    $soal->UpdateSoalModul($_POST['up_soal_id'], 'modul_10_ra', $arr_kolom, $arr_data, $pindah_html, 9, 10);
}
...
if (isset($_POST['update_modul'])) {
    ...
    $soal->UpdateSoalModul($_POST['up_id'], 'soal', $array_kolom, $array_data, $pindah_html, 11, 12);
}

if (isset($_POST['delete_soal'])) {
    $pindah_html = '../soal/modul_10_ra';
    $soal->HapusSoalModul($_POST['up_id'], $_POST['up_soal_id'], 'modul_10_ra', $pindah_html, 13, 14);
}
