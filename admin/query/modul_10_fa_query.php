...
if (isset($_POST['add_soal'])) {
    ...
    $pindah_halaman = '../soal/modul_10_fa';
    $tempat_upload  = '../gambar_soal/';


    $soal->TambahSoalModul1($soal_id, 'modul_10_fa', $nomor_soal, $link_gambar, $kunci_jawaban, $tempat_upload, $pindah_halaman);
}
...
if (isset($_POST['update_soal'])) {
    ...
    echo $gambar_lama;
    $soal->UpdateSoalModul1($id, 'modul_10_fa', $soal_id,  $nomor_soal, $gambar_lama, $gambar_baru, $kunci_jawaban, $tempat_upload, $pindah_halaman);
}
