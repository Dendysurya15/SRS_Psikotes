...
if (isset($_POST['buat_room'])) {
    ...
    if (
        isset($_SESSION['linkErr']) || isset($_SESSION['meeting_idErr']) || isset($_SESSION['nama_roomErr']) ||
        isset($_SESSION['password_roomErr']) ||  isset($_SESSION['tanggal_roomErr']) ||  isset($_SESSION['jam_mulaiErr']) ||  isset($_SESSION['jam_selesaiErr'])
    ) {
        header('location:../room/tambah_room');
    } else {
