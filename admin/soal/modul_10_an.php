...
$resultDataSoalModul10        = $dataModul->SelectDataSoalModul($soal_id, 'modul_10_an');

$pilihan    = '';
$arr_abjad  = range('a', 'z');
$jum        = '';

$nomor_soal     = $dataModul->NomorSoal($soal_id, 'modul_10_an');
...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form action="../query/modul_10_an_query" method="post" enctype="multipart/form-data">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form action="../query/modul_10_an_query" method="post">
                        <div class="card">
                            <div class="card-body">
                                <table class="table table-bordered table-hover text-center">
                                    <thead>
