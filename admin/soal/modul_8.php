...
$resultDataSoalModul8    = $dataModul->SelectDataSoalModul($soal_id, 'modul_8');

$nomor_soal     = $dataModul->NomorSoal($soal_id, 'modul_8');
...
if (isset($_GET['status'])) {
    ...
    switch ($status) {
        ...
        case 2:
            echo '<script>
                    var html = "Query Menambahkan Soal Bermasalah";
                    alert(html);
                </script>';
            break;
        case 3:
...
<div class="content-wrapper">
        ...
        <div class="content-fluid ">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    ...
                    <a href="modul_8?soal_id=<?= $soal_id ?>" class="float-sm-right ml-2 mr-3">
    ...
    <section class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form role="form" action="../query/modul_8_query.php" method="POST">
                            <div class="card-body">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form action="../query/modul_8_query" method="post" enctype="multipart/form-data">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form action="../query/modul_8_query.php" method="post">
                        <div class="card">
                            <div class="card-body">
                                <table class="table table-bordered table-hover text-center">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:50%;">
                                            <textarea autofocus name="add_teks" cols="30" rows="2" class="form-control mt-2" placeholder="Pernyataan ..."></textarea>
                                        </td>
                                        <td style="vertical-align:middle;">
                                            <select name="add_kategori" class="form-control">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="rekapTaksasi" class="table table-bordered table-hover text-center">
                                ...
                                <tbody>
                                    <?php if ($resultDataSoalModul8->num_rows > 0) : ?>
                                        <?php
                                        while ($rowDataSoalModul8 = $resultDataSoalModul8->fetch_assoc()) {
                                            echo '<form action="../query/modul_8_query.php" method="POST">';
                                            echo '<input type="hidden" name="update_id" value="' . $rowDataSoalModul8['id'] . '">';
                                            echo '<input type="hidden" name="update_soal_id" value="' . $soal_id . '">';
                                            echo '<tr>';
                                            echo '<td style="width:12%; vertical-align:middle;">
                                                            ' . $rowDataSoalModul8['nomor_soal'] . '
                                                            </td>';
                                            echo '<td style="width:12%; vertical-align:middle;">
                                                                <textarea name="update_teks" cols="30" rows="2" class="form-control mt-2" placeholder="Pernyataan ...">' . $rowDataSoalModul8['pernyataan'] . '</textarea>
                                                            </td>';

                                            echo '
                                                            <td style="vertical-align:middle;">
                                                                <select name="update_kategori" class="form-control">
                                                                    <option selected disabled value="' . $rowDataSoalModul8['kategori'] . '">' . strtoupper($rowDataSoalModul8['kategori']) . '</option>
                                                                    <option value="favorable">Favorable</option>
                                                                    <option value="unfavorable">Unfavorable</option>
                                                                </select>
                                                            </td>
