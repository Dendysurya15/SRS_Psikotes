...
$resultDataSoalModul1    = $dataModul->SelectDataSoalModul($soal_id, 'modul_10_wu');

$nomor_soal     = $dataModul->NomorSoal($soal_id, 'modul_10_wu');
...
<div class="content-wrapper">
    ...
    <section class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form role="form" action="../query/modul_10_wu_query" method="POST">
                            <div class="card-body">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form action="../query/modul_10_wu_query" method="post" enctype="multipart/form-data">
                                ...
                                <tbody>
                                    <?php if ($resultDataSoalModul1->num_rows > 0) : ?>
                                        <?php while ($rowsDataSoalModul1 = $resultDataSoalModul1->fetch_assoc()) : ?>
                                            <form action="../query/modul_10_wu_query.php" method="POST" enctype="multipart/form-data">
